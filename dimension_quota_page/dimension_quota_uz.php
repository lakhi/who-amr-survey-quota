...
$QUOTA_UZ_GENDER = [1 => 1, 2 => 1];                                    // test values; production: update with actual targets
$QUOTA_UZ_AGE    = [1 => 1, 2 => 1, 3 => 1, 4 => 1, 5 => 1, 6 => 1];  // test values; production: update with actual targets
$QUOTA_UZ_EDU    = [1 => 1, 2 => 1];                                    // test values; production: update with actual targets
